            ...
            <section className="bg-white min-h-screen flex box-border justify-center items-center">
                <div className="bg-white rounded-2xl flex max-w-3xl p-5 items-center">
                    <div className="md:w-1/2 px-8">
                        ...
                        <p className="text-sm mt-4 text-[#002D74]">Enter your credential to enter your account</p>
                        ...
                        <div className="mt-2 text-sm flex justify-between items-center container-mr">
                            ...
                            <Link to={"/signup"}><button className="hover:border register text-white bg-[#002D74] hover:border-gray-400 rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300">Register</button></Link>
